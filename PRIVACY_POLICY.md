...
This is an open source Android app developed by Josef Friedrich. The source code is available on GitHub under the GPL-3.0 license; the app is also available on Google Play.
